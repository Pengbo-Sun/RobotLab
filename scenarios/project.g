...
tables3(world){
  shape:ssBox, Q:<t(-1.6 0.6 1.0) d(90 0 0 1)>, size:[.2 .5 .05 .01], color:[.3 .3 .3]
    contact, logical:{ }
    friction:.1
}
...
dart2{ shape:cylinder, size:[0.15 0.01], color:[0 0 255],mass:0.2,X:<[-1.6,0.6, 1.07, 0, 0, 1, 0]>,contact=1}
dart3{ shape:cylinder, size:[0.15 0.01], color:[0 0 255],mass:0.2,X:<[-1.7,0.6, 1.07, 0, 0, 1, 0]>,contact=1}
